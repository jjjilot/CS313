...
class BinarySearchTree:
    ...
    def inorder_traversal(self):
        ...
        self._inorder_traversal_recursive(self.root, output)
        
        return output

    def _inorder_traversal_recursive(self, current, output):
        if current is not None:
            self._inorder_traversal_recursive(current.left, output)
            output.append(current.value)
            self._inorder_traversal_recursive(current.right, output)
